...
int						fill_others_center(char **tab,
							char **g_lines, int c, int j);
int						fill_others_last(char **tab,
							char **g_lines, int c, int j);
int						g_save;
int						g_saveplayer;
...
void					posplayer(int g_height, int g_width,
							char **g_lines, int indice);
...
char					*ft_substr_trim(char const *s,
							unsigned int start, size_t len);
